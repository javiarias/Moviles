...
public class showVideoButton : MonoBehaviour, IUnityAdsListener //Es basicamente igual que el rewarded, pero cambia el myPlacementId ¿Unificar en una con un booleano?
{
    ...
    void Start()
    {
        ...
        if (myButton) // Map the ShowRewardedVideo function to the button’s click listener:
            myButton.onClick.AddListener(ShowVideo);
